...
## Application
### מערכת ניהול מלון - הוראות הפעלה ותיעוד טכני

### הוראות הפעלה

### דרישות מקדימות
1. Python 3.8 ומעלה
2. PostgreSQL מותקן בדוקר
3. חבילות Python הנדרשות:
   - PyQt5
   - psycopg2

### התקנה והפעלה
1. הפעלת סביבת העבודה הווירטואלית:
```bash
cd c:\projects\hotel_management
venv\Scripts\activate
```

2. וידוא שה-PostgreSQL רץ בדוקר עם הפרמטרים הבאים:
```
host: localhost
port: 5432
database: postgres
...
#### דוחות
- דוח סיכום מלאי חודשי
- דוח בקשות תחזוקה פתוחות
- דוח חדרים הצריכים ניקוי
- דוח משימות תחזוקה אחרונות
- דוח ניתוח מחירי חדרים
- דוח מלאי לפי סוג חדר
- הרצת ניתוח תחזוקה
- הכנת חדר להזמנה
- ייצוא לקבצי CSV
...
- **SQL**: שאילתות ועבודה מול בסיס הנתונים
- **PyQt5**: ממשק משתמש גרפי

### תשתיות
- **PostgreSQL**: בסיס נתונים
- **Docker**: וירטואליזציה של בסיס הנתונים
- **Git**: ניהול גרסאות
...
hotel_management/
│
├── db_config.py     # ניהול התחברות לבסיס הנתונים
├── main.py         # חלון ראשי של האפליקציה
├── dashboard.py    # מסך סטטיסטיקות ראשי
├── rooms.py        # ניהול חדרים
├── reservation.py # ניהול הזמנות
├── staff.py        # ניהול צוות
├── maintenance.py  # ניהול תחזוקה
└── reports.py      # מערכת דוחות
```

### מודולים עיקריים

#### 1. מודול בסיס נתונים (db_config.py)
- מימוש תבנית Singleton
- ניהול חיבור לבסיס הנתונים
- טיפול בשגיאות התחברות

#### 2. מודול ראשי (main.py)
- ניהול ממשק משתמש ראשי
- ניווט בין מסכים
- ניהול תצוגה

#### 3. מודול חדרים (rooms.py)
- CRUD לחדרים
- ניהול סטטוס חדרים
- קישור לסוגי חדרים

#### 4. מודול הזמנות (reservation.py)
- ניהול הזמנות
- קישור לאורחים
- בדיקות זמינות

#### 5. מודול צוות (staff.py)
- ניהול עובדים
- הקצאת משימות
- מעקב ביצועים

#### 6. מודול תחזוקה (maintenance.py)
- ניהול קריאות שירות
- מעקב תיקונים
- ניהול מלאי

#### 7. מודול דוחות (reports.py)
- הפקת דוחות
- ייצוא נתונים
- ניתוח ביצועים
...
![image](https://github.com/user-attachments/assets/acaa4206-9260-493d-a5bc-a72942e6432d)
![image](https://github.com/user-attachments/assets/ce41d2c6-a52b-44f8-b7cd-0136f99eb98e)
![image](https://github.com/user-attachments/assets/eac7660a-7c80-4768-91cb-864078c19a23)
![image](https://github.com/user-attachments/assets/c687f118-6191-4bbd-8e0a-99a68deb3a0a)
